...
namespace Swashbuckle.AspNetCore.SwaggerGen
{
    public class SwaggerGenerator : ISwaggerProvider
    {
            ...
            ISchemaRegistry schemaRegistry)
        {
            ...
            {
                Content = CreateRequestMediaTypes(apiDescription, methodAttributes, schemaRegistry),
            };
        }

        private IDictionary<string, OpenApiMediaType> CreateRequestMediaTypes(
            ApiDescription apiDescription,
            IEnumerable<object> methodAttributes,
            ISchemaRegistry schemaRegistry)
        {
        ...
        private IEnumerable<string> InferRequestMediaTypes(ApiDescription apiDescription, IEnumerable<object> methodAttributes)
        {
            ...
            var specifiedMediaTypes = methodAttributes.OfType<ConsumesAttribute>()
                .SelectMany(attr => attr.ContentTypes)
                .Distinct();
            if (specifiedMediaTypes.Any()) return specifiedMediaTypes;
